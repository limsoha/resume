...
- 주요 업무 및 성과:
    ...
    - 핵심 리팩터링 및 아키텍처 개선
        - UI: 기존 XML 화면을 Jetpack Compose로 전환 완료 (100%), 개발 생산성 향상 및 UI 유지보수 비용 절감
        - DI: Koin → Hilt 마이그레이션으로 공식 지원 기반 DI 체계 확립, 테스트 및 의존성 관리 용이성 확보
        - 아키텍처: Clean Architecture 적용, 관심사 분리 및 모듈 간 의존성 최소화로 확장성과 안정성 강화
    - 배포 프로세스 자동화: Fastlane을 활용해 Firebase App Distribution(Staging)과 Play Store(Prod) 배포 자동화, 배포 시 Slack 알림 및 Git Tag 생성
    - Google AdMob 및 쿠팡 파트너스 연동을 통한 수익화 구조 구축: 월 수익 US$1,320 달성 연동으로 배포 효율성 향상
...
### 사내 숙소 예약 프로세스 개선 – 크로스플랫폼 예약 시스템 구축

사내 양양 사옥 예약을 구글폼·스프레드시트 수기 관리에서 실시간 예약 시스템으로 전환한 사내 프로젝트

- 기간 : 2026.02 ~ 2026.04
- 역할 : 팀원 (Android/CMP 개발 주도)
- 개발환경 : MacOS, Android Studio, Figma
- 기술 스택 : Kotlin, Compose Multiplatform (CMP), Android, Swift, JavaScript, Koin, Ktor
#### Web
<img width="800" alt="스크린샷 2026-04-03 오전 11 07 19" src="https://github.com/user-attachments/assets/41b4e11f-af0d-4572-bdd7-9fe2f2451ef2" />
<img width="800" alt="스크린샷 2026-04-03 오전 11 06 47" src="https://github.com/user-attachments/assets/5728cd5b-fc92-44ad-99e1-b6ff7fa649c0" />
<img width="800" alt="스크린샷 2026-04-03 오전 11 06 22" src="https://github.com/user-attachments/assets/f0889ee7-f35d-4b02-8bda-7c942a24e072" />
<img width="800" alt="스크린샷 2026-04-03 오전 11 06 07" src="https://github.com/user-attachments/assets/c626eed3-ce72-4b60-83e3-619c6c799c25" />

#### Mobile Web
<img width="200" alt="스크린샷 2026-04-03 오전 11 07 31" src="https://github.com/user-attachments/assets/b74d426c-8f15-4ddb-b81b-88ea1e0a4b0e" />
<img width="200" alt="스크린샷 2026-04-03 오전 11 07 26" src="https://github.com/user-attachments/assets/5e32ed2c-d204-452b-b6cc-ec976de21413" />
<img width="200" alt="스크린샷 2026-04-03 오전 11 19 15" src="https://github.com/user-attachments/assets/ca0dbd47-3d15-4f37-863f-451d538ba181" />
<img width="200" alt="스크린샷 2026-04-03 오전 11 07 35" src="https://github.com/user-attachments/assets/2a751af4-40c4-4c84-91b7-b658d115981e" />
